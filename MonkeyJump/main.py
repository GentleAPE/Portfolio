...
player = pygame.transform.scale(pygame.image.load('MonkeyJump/assets/monkey-onground.png'), (70, 50))
fps = 60
...
high_score = 0
game_over = False
jump_sound = pygame.mixer.Sound('MonkeyJump/sounds/arcade-game-jump-epic-stock-media-1-00-00.mp3')
...
player_x = 170
player_y = 400
platforms = [[175, 480, 70, 10], [85, 376, 70, 10 ], [265, 370, 70, 10],[175, 260, 70, 10], [85, 150, 70, 10 ], [265, 150, 70, 10], [175, 40, 70, 10] ]
jump = False
y_change = 0
x_change = 0
player_speed = 3
...
def check_collisions(rect_list, j):
    ...
    for i in range(len(rect_list)):
        if rect_list[i].colliderect([player_x + 20 , player_y + 60, 20, 5]) and jump == False and y_change > 0:
            j = True
    return j
    

#update player y postion every loop
...
def update_platforms(my_list, y_pos, change):
    ...
    for item in range(len(my_list)):
        if my_list[item][1] > 500:
            my_list[item] = [random.randint(10, 330), random.randint(-50, -10),70, 10]
            score += 1
    return my_list
...
while running == True:
    ...
    if x_change > 0: 
        ...
        player = pygame.transform.flip(pygame.transform.scale(pygame.image.load('MonkeyJump/assets/monkey-onground.png'), (70, 50)),1, 0,) 
